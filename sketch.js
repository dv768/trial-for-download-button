...
function setup() {
  ...
  // --- PNG BUTTON ---
let pngButton = createButton('PNG');
pngButton.style('position', 'absolute');
pngButton.style('left', '20px');   // padding from left
pngButton.style('bottom', '70px'); // padding from bottom so it doesn't collide
pngButton.style('padding', '6px 12px');
pngButton.style('font-family', 'monospace');
pngButton.style('font-size', '12px');
pngButton.style('color', '#00FF00'); // same green as UI
pngButton.style('background', 'transparent');
pngButton.style('border', '1px solid #00FF00');
pngButton.style('border-radius', '4px');
